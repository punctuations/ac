			...
			<div className="bg">
				<div className="h-full w-full absolute flex items-center justify-center">
					<motion.svg
						...
						className="2xl:h-64 xl:h-64 lg:h-64 md:h-48 sm:h-48 h-28 2xl:w-64 xl:w-64 lg:w-64 md:w-48 sm:w-48 w-28 2xl:mb-64 xl:mb-64 lg:mb-64 md:mb-40 sm:mb-32 mb-8 2xl:-ml-72 xl:-ml-72 lg:-ml-72 md:-ml-36 sm:ml-40 -ml-8 drop-shadow absolute flex items-center justify-center xl:z-0 lg:z-0 md:z-0 sm:z-10 z-0"
					>
						<path
							fill="#AF6FCB"
				...
				<div className="h-full w-full absolute flex 2xl:flex-row xl:flex-row lg:flex-row md:flex-row flex-col items-center justify-center">
					...
					<motion.div
						...
						animate="enter"
						variants={second}
						className="glass 2xl:z-0 xl:z-0 lg:z-0 md:z-20 sm:z-20 z-0 2xl:ml-80 xl:ml-80 lg:ml-80 md:ml-64 sm:ml-64 ml-12 2xl:mt-64 xl:mt-64 lg:mt-64 md:mt-40 sm:mt-0 mt-12 absolute rounded-xl 2xl:p-12 xl:p-12 lg:p-12 md:p-6 sm:p-6 p-3 text-white font-semibold shadow-2xl 2xl:text-3xl xl:text-3xl lg:text-3xl md:text-xl sm:text-lg text-sm"
					>
